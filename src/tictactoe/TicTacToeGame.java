...
/**
 * TicTacToeGame is about game that have 2 player take turns to marking the
 * space with X or O (if player1 is O, player2 is X). The player who succeeds in
 * placing their marks in a horizontal, vertical, or diagonal row wins the game.
 */
